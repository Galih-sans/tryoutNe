<?= $this->extend('user/layout/app-no-navbar-preview') ?>
    ...
    <div class="row items-push ">
        <div class="content content-boxed">
            <div class="row">
                ...
                <?=form_open(route_to(''), array('id'=>'ujian'), array('id'=> $data['test']->id));?>
                        ...
                        <div class="block-header block-content-full bg-neo-dark ribbon ribbon-modern ribbon-glass">
                            ...
                            <div class="text-right">
                                <div class="ribbon-box">
                                    <a class="badge link-fx text-white ">Timer Test</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12 col-md-12 py-2 border-bottom">
                                    <div class="row text-left bg-body-light  rounded-top">
                                        ...
                                        <div class="col-8 col-md-9 px-4">
                                            <span
                                                class="mt-2 mb-0 fw-medium h6">Nama Siswa</span>
                                        </div>
                                            <div class="col-12 col-md-12 text-center py-4">
                                                <a class="selesai action submit btn btn-sm btn-flat btn-block text-white w-100 mb-2" onclick="kembali();">Kembali</a>
                                            </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    var url = "<?= route_to('admin.test.get_test_preview') ?>";
</script>
...
<script src="<?=base_url('assets-front\js\pages\sheet-preview.js')?>"></script>
<?= $this->endSection() ?>