    ...
    <div class="card-body p-3">
        <div class="card-header pb-0">
            <div class="d-flex align-items-center">
                ...
                <button class="btn btn-info btn-sm ms-auto" id="update">Simpan Profil</button>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="<?= $userData->parent_name ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Nomer Telepon</label>
                        <input class="form-control" type="text" value="<?= $userData->parent_phone_number ?>">
                    </div>
                </div>
            </div>
            <!-- Data Sekolah -->
